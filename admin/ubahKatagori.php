...
$row = query("SELECT* FROM katagori WHERE id = $id")[0];

if (isset($_POST["ubah"])) {

    if (ubahKatagori($_POST) > 0) {
        echo "
        <script>
            alert('data berhasil duibah!');
            document.location.href = 'katagori.php';
        </script>";
    } else {
        echo "
        <script>
            alert('data gagal duibah!');
            document.location.href = 'katagori.php';
        </script>";
    }
}
                    ...
                    <div class="col-md-4">
                        <form action="" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama" autocomplete="off" autofocus value="<?= $row["nama"] ?>">
                            </div>

                            <button type="submit" class="btn btn-outline-primary" name="ubah">Ubah</button>
                        </form>
                    </div>
                </div>
            </div>
